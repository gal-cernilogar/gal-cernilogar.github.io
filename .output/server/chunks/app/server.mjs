...
const _routes = [
  {
    ...
    component: () => import('./_nuxt/index-5a927e63.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  blank: () => import('./_nuxt/blank-26d73daf.mjs').then((m) => m.default || m),
  default: () => import('./_nuxt/default-4a994bf9.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-8df85061.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, useNuxtApp as a, useHead as b, createError as c, useRouter as d, entry$1 as default, navigateTo as n, useState as u };
